        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(user.equals("")){
                    ...
                    final ProgressDialog pd = new ProgressDialog(Chat_login.this);
                    ...
                    StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>(){
                        ...
                        public void onResponse(String s) {
                            if(s.equals("null")){
                                Toast.makeText(Chat_login.this, "user not found", Toast.LENGTH_LONG).show();
                            }
                            else{
                                try {
                    ...
                    RequestQueue rQueue = Volley.newRequestQueue(Chat_login.this);
                    rQueue.add(request);
                }
